...
<div class="modal fade" id="del<?= $galeri->id_galeri;?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="<?= base_url('admin/gallery/del_galeri/'.$galeri->id_galeri);?>" class="btn btn-default btn-outline-light">Ya, Hapus Data</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <select name="posisi" class="form-control">
                  ...
                  <option value="Draft" <?php if($galeri->posisi=="Draft"){echo "selected";} ?>>Homepage</option>
                </select>
              </div>
            </div>
            <div class="form-group row">
