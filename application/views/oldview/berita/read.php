          ...
          <div class="col-lg-8 posts-list">
            <div class="single-post">
              <div class="feature-img">
                <img
                  class="img-fluid"
                  src="<?= base_url(); ?>assets/template/img/blog/single_blog_1.png"
                  alt=""
                />
              </div>
              ...
              <div class="navigation-area">
                <div class="row">
                  ...
                  >
                    <div class="thumb">
                      <a href="#">
                        <img
                          class="img-fluid"
                          src="<?= base_url(); ?>assets/template/img/post/preview.png"
                          alt=""
                        />
                      </a>
                    </div>
                  ...
                  >
                    ...
                    <div class="thumb">
                      <a href="#">
                        <img class="img-fluid" src="<?= base_url(); ?>assets/template/img/post/next.png" alt="" />
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div class="blog-author">
              <div class="media align-items-center">
                <img src="<?= base_url(); ?>assets/template/img/blog/author.png" alt="" />
            ...
            <div class="comments-area">
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="<?= base_url(); ?>assets/template/img/comment/comment_1.png" alt="" />
                    </div>
                    <div class="desc">
                      <p class="comment">
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="<?= base_url(); ?>assets/template/img/comment/comment_2.png" alt="" />
                    </div>
                    <div class="desc">
                      <p class="comment">
                        Multiply sea night grass fourth day sea lesser rule open
              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    <div class="thumb">
                      <img src="<?= base_url(); ?>assets/template/img/comment/comment_3.png" alt="" />
                    </div>
                    <div class="desc">
                      <p class="comment">
                        Multiply sea night grass fourth day sea lesser rule open
            ...
            <div class="blog_right_sidebar">
              <aside class="single_sidebar_widget popular_post_widget">
                ...
                <div class="media post_item">
                  <img src="<?= base_url();?>assets/template/img/post/post_1.png" alt="post" />
                  <div class="media-body">
                    <a href="<?= base_url();?>berita/read">
                ...
                <div class="media post_item">
                  <img src="<?= base_url();?>assets/template/img/post/post_2.png" alt="post" />
                  <div class="media-body">
                    <a href="<?= base_url();?>berita/read">
                ...
                <div class="media post_item">
                  <img src="<?= base_url();?>assets/template/img/post/post_3.png" alt="post" />
                  <div class="media-body">
                    <a href="<?= base_url();?>berita/read">
                ...
                <div class="media post_item">
                  <img src="<?= base_url();?>assets/template/img/post/post_4.png" alt="post" />
                  <div class="media-body">
                    <a href="<?= base_url();?>berita/read">
